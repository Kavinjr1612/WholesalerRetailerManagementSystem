...
const AdminLogin: React.FC = () => {
  ...
  const handleForgotPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await sendEmail({
        to: email,
        subject: 'Password Reset - Sweet & Snacks Wholesaler Admin',
        html: `
        ...
        {showForgotPassword ? (
          ...
          <>
            ...
            <div className="mb-6 p-4 rounded-md bg-blue-900/40 border border-blue-500/30">
              ...
              <p className="text-slate-300 text-sm mb-1"><span className="text-slate-400">Email:</span> admin123@gmail.com</p>
